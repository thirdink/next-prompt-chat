drop function if exists "public"."insert_chat_message"(chat_id uuid, message_content text, role role, temp double precision, max_length_tokens integer, top_p double precision, title text);
